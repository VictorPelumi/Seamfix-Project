          ...
          <table className="w-full text-left text-sm text-gray-500">
            ...
            <tbody>
              <tr className="border-b bg-white text-sm text-gray-700">
                ...
                <td className="whitespace-nowrap py-4 px-6">End point</td>
                <td className="whitespace-nowrap py-4 px-6">10.1.101.53</td>
                <td className="whitespace-nowrap py-4 px-6">
                ...
                <div className="px-12 py-8  ">
                  ...
                  <div className="px-12 w-2/3 space-y-4 mx-auto">
                    <div className="flex items-center space-x-4">
                      <p className="w-32">Application Name</p>
                    ...
                    <div className="flex items-center space-x-4">
                      <p className="w-32">Application Type</p>
                      <input className="rounded-md flex-1 border border-gray-200 bg-gray-50 py-3 px-2 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-600" />
                    </div>
                    <div className="flex items-center space-x-4">
                      <p className="w-32">Application Desc</p>
                      <input className=" rounded-md flex-1 border border-gray-200 bg-gray-50 py-3 px-2 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-600" />
                    </div>
                    <div className="flex items-center space-x-4">
                      <p className="w-32">Application Port</p>
                      <input className=" rounded-md flex-1 border border-gray-200 bg-gray-50 py-3 px-2 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-600" />
                    </div>
                    <div className="flex items-center space-x-4">
                      <p className="w-32">End Point</p>
                      <input className=" rounded-md flex-1 border border-gray-200 bg-gray-50 py-3 px-2 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-600" />
                    </div>
                    <div className="flex space-x-6 mt-6 ">
                      ...
                      <div className="w-full">
                        ...
                        <div className="mt-6">
                          <h2 className="mb-2">Select Application</h2>
                          <div className="border w-full px-3 py-2">
